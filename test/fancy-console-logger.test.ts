...
describe('Logger console logs content', () => {
  ...
  test('Log function should log the title and payload', () => {
    console.log = jest.fn();
    fconsole.log('Some test', { another: 'test', anotherMore: 'test' })
  ...
  test('Log function should log the title in color red', () => {
    console.log = jest.fn();
    fconsole.log('This text should be red', {}, TextColors.Red)
  ...
  test('Log function should log the title and the name of the file', () => {
    console.log = jest.fn();
    fconsole.log('This should show info', {}, null, true)
  ...
  test('Log function should log the title, the payload, in color and the name of the file', () => {
    console.log = jest.fn();
    fconsole.log('This should show green', { test: 'test' }, TextColors.Green, true)
